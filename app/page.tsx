...
const benefits = [
  {
    ...
    icon: SaveIcon,
    accent: 'from-brand-cyan/25 to-brand-cyan/5',
  },
  {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative -mt-20 isolate">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl sm:p-12">
            <div className="absolute inset-0 bg-gradient-to-br from-brand-cyan/8 via-transparent to-brand-cyan/5" />
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-brand-cyan via-brand-cyanLight to-brand-cyan" />
      ...
      <section id="products" className="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 h-96 w-96 rounded-full bg-brand-cyan/5 blur-3xl" />
                ...
                >
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-gradient-to-br from-slate-100 to-slate-50">
                    ...
                    <div className="absolute right-4 top-4 z-10">
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-brand-cyan/10 border border-brand-cyan/20 px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-widest text-brand-cyan backdrop-blur-sm">
                        {badgeText}
                      </span>
                    </div>
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            {benefits.map((benefit) => {
              ...
              return (
                <div
                  key={benefit.title}
                  className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-card transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl sm:p-10 hover:border-transparent"
                >
        ...
        <div className="relative mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link
                href="/contact"
                className="group inline-flex w-full items-center justify-center gap-2.5 rounded-full border-2 border-white/30 bg-transparent px-10 py-5 text-lg font-black text-white backdrop-blur-sm transition-all hover:border-brand-cyan hover:bg-white/10 hover:-translate-y-0.5 sm:w-auto"
              >
                Contact Us
              </Link>
            </div>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm">
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-slate-300 backdrop-blur-sm">
                <span className="h-2 w-2 rounded-full bg-brand-cyan animate-pulse" />
                <span className="font-bold text-white">Open Today</span>
                <span className="text-slate-400">· 8AM – 6PM</span>
              </div>
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-slate-300 backdrop-blur-sm">
                <span className="h-2 w-2 rounded-full bg-brand-cyan animate-pulse" />
                <span className="font-bold text-white">Tema, Community 10</span>
                <span className="text-slate-400">· Apple Ave 202</span>
              </div>
            </div>
