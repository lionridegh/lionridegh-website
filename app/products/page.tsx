    ...
    <section className="space-y-10">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {products.map((product) => (
          <article key={product.slug} className="overflow-hidden rounded-[2rem] border border-slate-200 border-l-[3px] border-l-brand-red bg-white shadow-soft">
            ...
            <div className="space-y-4 p-8">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-full bg-brand-cyan/10 px-3 py-1 text-sm font-semibold text-brand-cyan">{product.type}</span>
              </div>
